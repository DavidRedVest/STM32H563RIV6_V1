#ifndef __MODBUS_PRIVATE_H__
#define __MODBUS_PRIVATE_H__
...
/* 定义打印函数 */
#define MODBUS_ENABLE_DEBUG   1

#if MODBUS_ENABLE_DEBUG
#define MODBUS_DEBUG(...)   rt_kprintf(__VA_ARGS__)
#else
#define MODBUS_DEBUG(...)
#endif
...
struct _modbus{
	...
	struct timeval response_timeout;	//回复超时时间
	struct timeval byte_timeout;
	struct timeval indication_timeout;	//请求超时时间
